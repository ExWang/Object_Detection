...
predict_filename = "caption_test2076852.json"  # Best conclusion
...
for image in predict:
    ...
    if image_name not in ground_truth:
        ...
        if ground_truth[image_name]["action"] in list(set(predict_action)):
            ...
            print imgname_jpg, 'Wrong: Truth value:', ground_truth[image_name]["action"], ' Predict value:', list(set(predict_action))

            #print imgname_jpg, 'Wrong: Truth value:', action_list[ground_truth[image_name]["action"]], ' Predict value:', predict_action_str
            # Save images
            src_path = path + 'test'
